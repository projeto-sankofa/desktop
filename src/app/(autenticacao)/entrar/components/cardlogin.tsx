  ...
  return (
    <Card className="w-full max-w-lg mx-auto bg-card shadow ">
      <CardHeader className="space-y-1 text-center">
        <CardTitle className="text-7xl font-bold tracking-tight py-4 text-card-foreground">Sankofa<span className="text-primary">.</span>AI</CardTitle>
      </CardHeader>
      <CardContent className="space-y-6 px-6 pb-8">
        <Button
          variant="default"
          className="w-full  hover:opacity-95 text-white text-xl py-8 rounded-none"
        ...
        >
          {isLoading.google ? (
            ...
            <Chrome className="mr-2 h-5 w-10" />
          )}
          Google
        </Button>
        <Button
